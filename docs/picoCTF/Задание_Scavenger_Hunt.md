...
Третья часть лежит в /robots.txt (рис 2) t_0f_pl4c

![img](media/Задание_Scavenger_Hunt/media/image2.png)

Вторая часть оказалась в mycss.css (рис 3) h4ts_4_l0

![img](media/Задание_Scavenger_Hunt/media/image3.png)

Но нужна 4 часть флага. Проверим (рис 4) 3s_2_lO0k. И снова нет скобки, а значит идем дальше
